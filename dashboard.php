<?php
	...
	if (!$conn) {
		...
		$officers_rating_decimal = round($officers_rating[0], 2);
		$officers_rating_percent = $officers_rating[0]*20;
	} 
?>
	...
	<div class="container">
		...
		<main>
			<div class="info-data">
					...
					<div class="card">
						<div>
							<h2>LITL PERFORMANCE</h2>
							<div class="stars-holder">
								<div class="stars">
									<span style="width: <?php echo $officers_rating_percent?>%;"> </span>
									<div class="description"> 
										<b class="number"> <?php echo $officers_rating_decimal?> </b>
									</div>
								</div>
							</div>
						</div>
